...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 13 Décembre 2016 à 10:37
...
(102, 'HONORE DE BALZAC', 'Pere Goriot'),
...
--
ALTER TABLE `abonne`
  MODIFY `id_abonne` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `emprunt`
  ADD CONSTRAINT `emprunt_ibfk_1` FOREIGN KEY (`id_livre`) REFERENCES `livre` (`id_livre`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `emprunt_ibfk_2` FOREIGN KEY (`id_abonne`) REFERENCES `abonne` (`id_abonne`) ON DELETE CASCADE ON UPDATE CASCADE;
--
...
CREATE TABLE `movies` (
  ...
  `category` enum('horreur','fantastique') NOT NULL,
...
(1, 'Avengers 4', 'googleman', 'googleman', 'googleman', 2002, 'Français', 'horreur', 'zazeazeazeazezaeazeza', 'https://www.google.fr/');
...
INSERT INTO `jeu` (`id`, `nom`, `description`, `nombre_joueur`, `date`, `image`) VALUES
(2, 'Street fighter VI alpha turbo mega remix fury reload arcade edition v2', 'Jeu de combat en VR ', 2, '2018-02-16', '091d411d95ce5333937d90bb6761b24d'),
(3, 'Kingdom hearts', 'Un a-rpg de malade ', 1, '2001-04-12', 'e30e15fb823a95fbbe5e94e7d7a3d49e');
...
(1, 1, 1, 'c\'est de la merde', 1, '2016-11-17 00:00:00'),
(2, 2, 2, 'super moche et ca sent la sueur !!!', 2, '2016-11-11 00:00:00'),
(3, 0, 3, 'cool', 4, '2016-11-16 00:00:00'),
(4, 0, 4, 'szde', 3, '2016-11-10 00:00:00'),
(5, 2, 3, 'cool', 4, '2016-11-16 00:00:00'),
(6, 3, 4, 'szde', 3, '2016-11-10 00:00:00'),
(7, 4, 5, 'au top', 5, '2016-11-16 00:00:00'),
(8, 5, 6, 'pas mal', 3, '2016-11-18 00:00:00'),
(9, 2, 5, '', 4, '2016-11-08 00:00:00');
...
(4, 2, 2, '2016-11-16 00:00:00'),
(5, 2, 4, '2016-11-16 00:00:00'),
(6, 4, 2, '2016-11-24 00:00:00'),
(7, 5, 4, '2016-11-23 00:00:00'),
(8, 6, 6, '2016-11-13 00:00:00'),
(9, 3, 3, '2016-11-15 00:00:00');
...
(2, 'tata', 'tata', 'tata', 'tata', 'tata@hotmail.fr', 'f', 0, '2016-11-17 00:00:00'),
(3, 'titi', 'titi', 'titi', 'titi', 'titi@gmail.com', 'm', 0, '2016-11-16 00:00:00'),
(4, 'tutu', 'tutu', 'tutu', 'tutu', 'tutu@gmail.com', 'm', 0, '2016-11-01 00:00:00'),
(5, 'tete', 'tete', 'tete', 'tete', 'tete@gmail.com', 'm', 0, '2016-11-09 00:00:00'),
(6, 'tonton', 'tonton', 'tonton', 'tonton', 'tonton@gmail.com', 'm', 0, '2016-11-02 00:00:00');
...
(1, 1, '2016-11-15 00:00:00', '2016-11-18 00:00:00', 1000, 'libre'),
(2, 2, '2016-11-17 00:00:00', '2016-11-21 00:00:00', 2000, 'libre'),
(3, 3, '2016-11-24 00:00:00', '2016-11-27 00:00:00', 3000, 'libre'),
(4, 4, '2016-11-21 00:00:00', '2016-11-23 00:00:00', 4000, 'libre'),
(5, 5, '2016-11-09 00:00:00', '2016-11-12 00:00:00', 500, 'libre'),
(6, 6, '2016-11-22 00:00:00', '2016-11-25 00:00:00', 750, 'libre');
...
(1, 'Salon Picasso', 'Peintre', '', 'France', 'Paris', '45 rue du maréchal ', 75000, 100, 'reunion'),
(2, 'Salon Gauguin', 'Salle pour les ivrognes', '', 'France', 'Paris', '13 rue de la prostitution', 75000, 3, 'bureau'),
(3, 'salle van gogh', 'salle pour les fous', '', 'france', 'paris', 'rue de l\'etron', 75215, 69, 'formation'),
(4, 'bureau Renoir', 'salle d\'une famille de placé', '', 'france', 'paris', '27 rue de la charité', 75004, 2, 'bureau'),
(5, 'bureau Monet', 'Bureau pour faire les comptes', '', 'france', 'paris', '96 bd du plateau', 75006, 4, 'bureau'),
(6, 'salle Rembrandt', 'salle des lumières', '', 'France', 'Paris', '12, avenue george marchais', 75010, 1252, 'formation');
...
--
ALTER TABLE `salle`
  MODIFY `id_salle` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- Contraintes pour les tables exportées
--
...
ALTER TABLE `commande`
  ...
  ADD CONSTRAINT `commande_ibfk_2` FOREIGN KEY (`id_membre`) REFERENCES `membre` (`id_membre`) ON DELETE CASCADE;
...
CREATE TABLE `article` (
  ...
  `statut` enum('valide','non-valide','en-cours') NOT NULL DEFAULT 'non-valide'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `utilisateur` (
  ...
  `sexe` enum('femme','homme','non-défini') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `utilisateur` (`id`, `pseudo`, `mdp`, `email`, `avatar`, `sexe`) VALUES
(1, 'lighthinker', '$2y$10$gz/hCJcjefqjt32x1ZjKXegaCMTvQFJoE9PnX5sGxiqs.gPVk1UAS', 'lighthinker@hotmail.fr', 'default.png', 'homme'),
(2, 'thanos', '$2y$10$MdKi8aeUfQSsnpV8GIRMm.73aOcvPzWzWa6f/eRyVOaZHnR5EHixS', 'thanos@gmail.com', 'default.png', 'homme');
...
-- Base de données :  `t-chat`
--
CREATE DATABASE IF NOT EXISTS `t-chat` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `t-chat`;
...
INSERT INTO `messages` (`id`, `corps`, `image`, `date_creation`, `date_modification`, `id_utilisateur`, `id_salon`) VALUES
(1, 'Salut, tout le monde !', NULL, '2016-10-13 09:34:23', '2016-10-13 09:34:23', 1, 1),
(2, 'Coucou !', NULL, '2016-10-16 10:08:50', '2016-10-16 10:08:50', 1, 2),
(3, 'Salut, et merci pour le poisson !', NULL, '2016-10-11 03:45:26', '2016-10-11 03:45:26', 2, 1),
(4, 'Lorem ipsum... ou pas.', NULL, '2016-10-13 14:17:45', '2016-10-14 07:00:50', 2, 2),
(5, 'Bijour, tout le monde !', NULL, '2016-10-16 12:35:09', '2016-10-17 11:24:09', 5, 4),
(6, 'Salut à toi !', NULL, '2016-10-16 14:15:47', '2016-10-16 14:15:47', 2, 4),
(7, 'Mais qu\'est-ce qui se passe dans ce salon ?', NULL, '2016-10-14 17:12:44', '2016-10-14 20:12:44', 2, 2),
(8, 'Je ne sais pas. Je ne comprends pas non plus !', NULL, '2016-10-17 14:34:23', '2016-10-17 14:34:23', 6, 2),
(9, 'Je suis force bleue !', NULL, '2016-10-17 12:16:25', '2016-10-17 12:16:25', 7, 5),
(10, 'Je suis force rouge !', NULL, '2016-10-17 13:13:36', '2016-10-17 13:13:36', 6, 5),
(11, 'Je suis force jaune devant, marron derrière !', NULL, '2016-10-17 15:16:45', '2016-10-17 16:26:45', 1, 5),
(12, 'PHP, mon amour ! Lol :)', NULL, '2016-10-15 09:39:17', '2016-10-15 09:39:17', 1, 5),
(13, 'Oh yeah ! :)', NULL, '2016-10-16 07:40:11', '2016-10-17 07:40:11', 3, 1),
(14, 'Quel est ce maléfice ?', NULL, '2016-10-17 14:17:37', '2016-10-17 16:15:48', 3, 1),
(15, 'z\"\'e\'(\'(', NULL, '2016-10-25 10:32:40', '2016-10-25 10:32:40', 5, 1),
(16, 'drtertert', NULL, '2016-10-25 10:32:44', '2016-10-25 10:32:44', 5, 1),
(17, 'rtrterter', NULL, '2016-10-25 10:47:53', '2016-10-25 10:47:53', 5, 2),
(18, 'sdqzr', NULL, '2016-11-30 12:18:29', '2016-11-30 12:18:29', 13, 1),
(19, 'sdqzr', NULL, '2016-11-30 12:21:44', '2016-11-30 12:21:44', 13, 1),
(20, 'Bonjour je suis thanos', NULL, '2016-11-30 14:50:03', '2016-11-30 14:50:03', 13, 1),
(21, 'Bonjour je suis thanos', NULL, '2016-11-30 15:31:00', '2016-11-30 15:31:00', 13, 1),
(22, 'Bonjour je suis thanos', NULL, '2016-11-30 15:31:06', '2016-11-30 15:31:06', 13, 1);
...
INSERT INTO `salons` (`id`, `nom`) VALUES
(1, 'Les supers développeurs'),
(2, 'Les supers héros du PHP'),
(3, 'Les développeurs fous'),
(4, 'Les développeurs citoyens'),
(5, 'PHP, tout simplement le meilleur'),
(6, 'dsfe'),
(7, 'erezr');
...
CREATE TABLE `utilisateurs` (
  ...
  `sexe` enum('femme','homme','non-défini') COLLATE utf8_bin NOT NULL DEFAULT 'non-défini',
  `role` enum('superadmin','admin','utilisateur') COLLATE utf8_bin NOT NULL,
  `sexe2` varchar(255) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `utilisateurs` (`id`, `pseudo`, `mot_de_passe`, `email`, `avatar`, `sexe`, `role`, `sexe2`) VALUES
(1, 'Pierre', 'pierrotdu38', 'pierrot@gmail.com', 'default.png', 'homme', 'superadmin', ''),
(2, 'Marie', 'marie55#', 'marie55@gmail.com', 'default.png', 'femme', 'superadmin', ''),
(3, 'Cyrildu92', 'cyrilou21', 'cyrilou@gmail.com', 'default.png', 'homme', 'superadmin', ''),
(5, 'Googleman', 'leseullunique', 'googleman@gmail.com', 'default.png', 'non-défini', 'superadmin', ''),
(6, 'johncarmack', '0ohmyjohn0', 'johncarmack@mit.en', 'default.png', 'homme', 'superadmin', ''),
(7, 'Jacquy43', 'soeurjacques', 'jacquy43@orange.fr', 'default.png', 'femme', 'superadmin', ''),
(9, 'Thib', 'cfgdfgdf', 'gires7@mail.com', '760e071ded70ceb5aeb45eadac9e5336', 'homme', 'superadmin', ''),
(10, 'hacker', 'mdp', 'abc@mail.com', 'default.png', 'homme', 'superadmin', ''),
(11, 'NouveauTest', 'testtest', 'nouvtest@test.fr', '6ca75d982d973b2cd72b3b344aa34995', 'femme', 'superadmin', ''),
(12, 'Roro', 'roro', 'roro@gmail.com', 'default.png', 'homme', 'superadmin', ''),
(13, 'thanos', '$2y$10$3aZG7WvHoOAJO21bkqwAE.6oQFfqYmJ5wbAJtIVXjT.NBvtUegMk.', 'thanos@hotmail.fr', 'default.png', 'homme', 'utilisateur', ''),
(14, 'avenger', '$2y$10$vObG.VispbWBQgQFjG.tjubvvN/7mPuftbqrwr3QtEQYw3if0wNjG', 'avenger@gmail.com', 'default.png', 'homme', 'superadmin', ''),
(15, 'koala', '$2y$10$vaRjFIZN4Gz3sYPTOIUWg.1ET4lZGIPLqb0w2L1RwKqPGrJo3nQ8O', 'koala@gmail.com', 'default.png', 'homme', 'superadmin', NULL);
...
ALTER TABLE `messages`
  ...
  ADD CONSTRAINT `messages_ibfk_2` FOREIGN KEY (`id_salon`) REFERENCES `salons` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Base de données :  `ulysse`
--
CREATE DATABASE IF NOT EXISTS `ulysse` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ulysse`;
...
INSERT INTO `produit` (`id`, `idUtilisateur`, `nomproduit`, `description`, `montant`) VALUES
(2, 'b13', 'moto', 'ughkuhiljlkjkljhkjgjhghkjhkkljlkjlk', '100.00'),
(3, 'b13', 'télé', 'hiioujiouihyftyfdrtdsgh', '5000.00'),
(4, 'b13', 'ps5', '2050', '7000.00'),
(5, 'b13', 'msi', 'Futur', '40000.00'),
(6, 'b13', 'Galaxy s7', 'test', '600.00'),
(7, 'b13', 'erzer', 'zerzerzer', '100.00');
...
INSERT INTO `utilisateur` (`id`, `nom`, `prenom`, `login`, `mdp`, `fonction`) VALUES
('a131', 'Andre', 'David', 'dandre', 'oppg5', 'admin'),
('a55', 'Bedos', 'Christian', 'cbedos', 'gmhxd', 'utilisateur'),
('a93', 'Tusseau', 'Louis', 'ltusseau', 'ktp3s', 'utilisateur'),
('b13', 'Blabla', 'Rroro', 'roro', 'azerty', 'utilisateur');
...
ALTER TABLE `ficheproduit`
  ADD PRIMARY KEY (`idUtilisateur`,`nomproduit`);
...
(1, 1, 'Un commentateur WordPress', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2016-11-02 14:44:12', '2016-11-02 13:44:12', 'Bonjour, ceci est un commentaire.\nPour débuter avec la modération, la modification et la suppression de commentaires, veuillez visiter l’écran des Commentaires dans le Tableau de bord.\nLes avatars des personnes qui commentent arrivent depuis <a href=\"https://gravatar.com\">Gravatar</a>.', 0, '1', '', '', 0, 0);
...
(6, 'admin_email', 'eng.roland94@gmail.com', 'yes'),
...
(40, 'template', 'eprojet', 'yes'),
(41, 'stylesheet', 'eprojet', 'yes'),
...
(2, 6, '_edit_last', '1'),
(3, 6, '_edit_lock', '1478171003:1'),
(4, 9, '_edit_last', '1'),
(5, 9, 'field_581b3e908d99f', 'a:13:{s:3:\"key\";s:19:\"field_581b3e908d99f\";s:5:\"label\";s:7:\"Adresse\";s:4:\"name\";s:18:\"restaurant_adresse\";s:4:\"type\";s:8:\"textarea\";s:12:\"instructions\";s:0:\"\";s:8:\"required\";s:1:\"0\";s:13:\"default_value\";s:0:\"\";s:11:\"placeholder\";s:0:\"\";s:9:\"maxlength\";s:0:\"\";s:4:\"rows\";s:0:\"\";s:10:\"formatting\";s:2:\"br\";s:17:\"conditional_logic\";a:3:{s:6:\"status\";s:1:\"0\";s:5:\"rules\";a:1:{i:0;a:2:{s:5:\"field\";s:4:\"null\";s:8:\"operator\";s:2:\"==\";}}s:8:\"allorany\";s:3:\"all\";}s:8:\"order_no\";i:0;}'),
(6, 9, 'rule', 'a:5:{s:5:\"param\";s:9:\"post_type\";s:8:\"operator\";s:2:\"==\";s:5:\"value\";s:4:\"post\";s:8:\"order_no\";i:0;s:8:\"group_no\";i:0;}'),
(7, 9, 'position', 'normal'),
(8, 9, 'layout', 'no_box'),
(9, 9, 'hide_on_screen', ''),
(10, 9, '_edit_lock', '1478183691:1');
...
(1, 1, '2016-11-02 14:44:12', '2016-11-02 13:44:12', 'Bienvenue dans WordPress. Ceci est votre premier article. Modifiez-le ou supprimez-le, puis lancez-vous&nbsp;!', 'Bonjour tout le monde&nbsp;!', '', 'publish', 'open', 'open', '', 'bonjour-tout-le-monde', '', '', '2016-11-02 14:44:12', '2016-11-02 13:44:12', '', 0, 'http://localhost/wordpress/?p=1', 0, 'post', '', 1),
(2, 1, '2016-11-02 14:44:12', '2016-11-02 13:44:12', 'Voici un exemple de page. Elle est différente d’un article de blog, en cela qu’elle restera à la même place, et s’affichera dans le menu de navigation de votre site (en fonction de votre thème). La plupart des gens commencent par écrire une page « À Propos » qui les présente aux visiteurs potentiels du site. Vous pourriez y écrire quelque chose de ce tenant :\n\n<blockquote>Bonjour ! Je suis un mécanicien qui aspire à devenir un acteur, et voici mon blog. J’habite à Bordeaux, j’ai un super chien baptisé Russell, et j’aime la vodka-ananas (ainsi que regarder la pluie tomber).</blockquote>\n\n...ou bien quelque chose comme ça :\n\n<blockquote>La société 123 Machin Truc a été créée en 1971, et n’a cessé de proposer au public des machins-trucs de qualité depuis lors. Située à Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson, 123 Machin Truc emploie 2 000 personnes, et fabrique toutes sortes de bidules super pour la communauté bouzemontoise.</blockquote>\n\nÉtant donné que vous êtes un nouvel utilisateur de WordPress, vous devriez vous rendre sur votre <a href=\"http://localhost/wordpress/wp-admin/\">Tableau de bord</a> pour effacer la présente page, et créer de nouvelles pages avec votre propre contenu. Amusez-vous bien !', 'Page d&rsquo;exemple', '', 'publish', 'closed', 'open', '', 'page-d-exemple', '', '', '2016-11-02 14:44:12', '2016-11-02 13:44:12', '', 0, 'http://localhost/wordpress/?page_id=2', 0, 'page', '', 0),
(3, 1, '2016-11-02 14:44:26', '0000-00-00 00:00:00', '', 'Brouillon auto', '', 'auto-draft', 'open', 'open', '', '', '', '', '2016-11-02 14:44:26', '0000-00-00 00:00:00', '', 0, 'http://localhost/wordpress/?p=3', 0, 'post', '', 0),
(4, 1, '2016-11-03 11:17:21', '0000-00-00 00:00:00', '', 'Brouillon auto', '', 'auto-draft', 'open', 'open', '', '', '', '', '2016-11-03 11:17:21', '0000-00-00 00:00:00', '', 0, 'http://localhost/wordpress/?p=4', 0, 'post', '', 0),
(5, 1, '2016-11-03 11:43:47', '0000-00-00 00:00:00', '', 'Brouillon auto', '', 'auto-draft', 'open', 'open', '', '', '', '', '2016-11-03 11:43:47', '0000-00-00 00:00:00', '', 0, 'http://localhost/wordpress/?p=5', 0, 'post', '', 0),
(6, 1, '2016-11-03 12:01:33', '2016-11-03 11:01:33', 'ezrzer', 'restaurant 1', '', 'publish', 'open', 'closed', '', 'restaurant-1', '', '', '2016-11-03 12:01:33', '2016-11-03 11:01:33', '', 0, 'http://localhost/wordpress/?post_type=restaurant&#038;p=6', 0, 'restaurant', '', 0),
(7, 1, '2016-11-03 12:01:33', '2016-11-03 11:01:33', 'ezrzer', 'restaurant 1', '', 'inherit', 'closed', 'closed', '', '6-revision-v1', '', '', '2016-11-03 12:01:33', '2016-11-03 11:01:33', '', 6, 'http://localhost/wordpress/2016/11/03/6-revision-v1/', 0, 'revision', '', 0),
(8, 1, '2016-11-03 12:18:15', '0000-00-00 00:00:00', '', 'Brouillon auto', '', 'auto-draft', 'open', 'closed', '', '', '', '', '2016-11-03 12:18:15', '0000-00-00 00:00:00', '', 0, 'http://localhost/wordpress/?post_type=restaurant&p=8', 0, 'restaurant', '', 0),
(9, 1, '2016-11-03 14:43:11', '2016-11-03 13:43:11', '', 'restaurant', '', 'publish', 'closed', 'closed', '', 'acf_restaurant', '', '', '2016-11-03 14:43:11', '2016-11-03 13:43:11', '', 0, 'http://localhost/wordpress/?post_type=acf&#038;p=9', 0, 'acf', '', 0);
...
(14, 1, 'session_tokens', 'a:3:{s:64:\"ea4a86a9b5144a72aa06a7d8b1dfd52060f03650a745de75bd2daa10019bf252\";a:4:{s:10:\"expiration\";i:1478267065;s:2:\"ip\";s:3:\"::1\";s:2:\"ua\";s:73:\"Mozilla/5.0 (Windows NT 10.0; WOW64; rv:49.0) Gecko/20100101 Firefox/49.0\";s:5:\"login\";i:1478094265;}s:64:\"dadc4eea56d3b663cce5ca96a24ba5930a4df11c5dac679a656e1de4a4e565ca\";a:4:{s:10:\"expiration\";i:1478335536;s:2:\"ip\";s:3:\"::1\";s:2:\"ua\";s:73:\"Mozilla/5.0 (Windows NT 10.0; WOW64; rv:49.0) Gecko/20100101 Firefox/49.0\";s:5:\"login\";i:1478162736;}s:64:\"17d925325598f52b6db3ecd8a0b73800972552f5c4e65b97ac2567dbac1ac460\";a:4:{s:10:\"expiration\";i:1478335575;s:2:\"ip\";s:3:\"::1\";s:2:\"ua\";s:73:\"Mozilla/5.0 (Windows NT 10.0; WOW64; rv:49.0) Gecko/20100101 Firefox/49.0\";s:5:\"login\";i:1478162775;}}'),
...
(1, 'roro', '$P$BWcrfo4GWD1q.zgESbbHoJyEoz/AeP1', 'roro', 'eng.roland94@gmail.com', '', '2016-11-02 13:44:12', '', 0, 'roro');
